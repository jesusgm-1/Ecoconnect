...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        const fetchMetrics = async () => {
            try {
                ...
                const kgSalvados = transferidos.reduce((acc, curr) => acc + (curr.unidad === 'kg' ? curr.cantidad : 0), 0);
                ...
                const estadoData = Object.keys(estadosCount).map(k => ({ name: k, value: estadosCount[k] }));
                ...
                const tipoData = Object.keys(tipoCount).map(k => ({ name: k, count: tipoCount[k] }));
    ...
    return (
        <div>
            ...
            <p>Métricas en tiempo real sobre la economía circular en tu nodo regional.</p>
            ...
            <div style={styles.kpiContainer}>
                ...
                <div style={styles.kpiCard}>
                    ...
                    <p style={{...styles.kpiValue, color: '#4caf50'}}>{stats.totalKg.toFixed(2)} KG</p>
                </div>
            </div>
            ...
            <div style={styles.chartsContainer}>
                ...
                <div style={styles.chartBox}>
                    <h3 style={{textAlign: 'center', marginBottom: '1rem'}}>Publicaciones por Tipo</h3>
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={stats.tipoData} margin={{top: 5, right: 30, left: 20, bottom: 5}}>
                ...
                <div style={styles.chartBox}>
                    <h3 style={{textAlign: 'center', marginBottom: '1rem'}}>Estado Actual de Excedentes</h3>
                    <ResponsiveContainer width="100%" height={300}>
                        <PieChart>
                            <Pie
